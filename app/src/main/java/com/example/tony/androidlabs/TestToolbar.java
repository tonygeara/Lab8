    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "ACTIONS STARTS", Snackbar.LENGTH_LONG)
    ...
    public boolean onOptionsItemSelected(MenuItem mi){
        ...
        switch(mi.getItemId()){
            ...
            case R.id.action_four:
                Log.d("Toolbar","Option 4  ABOUT selected");
                Toast.makeText(getApplicationContext(), "Version 1.0 by Tony Geara", Toast.LENGTH_LONG).show();
                break;
        }
